    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
          ...
          <span className="text-2xl font-bold text-gray-900">{Number(animatedStats.totalDeposited).toFixed(2)} <span className="text-base font-medium text-gray-500">MUSD</span></span>
        </div>
        <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
          <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-2xl font-bold text-gray-900">{Number(animatedStats.totalWithdrawn).toFixed(2)} <span className="text-base font-medium text-gray-500">MUSD</span></span>
        </div>
        <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
          <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-2xl font-bold text-gray-900">{Number(animatedStats.totalInterest).toFixed(2)} <span className="text-base font-medium text-gray-500">MUSD</span></span>
        </div>
        <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
          <div className="flex items-center gap-2 mb-1">
      ...
      <div className="bg-white shadow rounded-lg mt-8">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500">Track your MUSD deposits, withdrawals, and earned interest.</p>
        </div>
        <div className="p-0">
              ...
              <table className="min-w-full bg-white">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="px-6 py-4 text-left text-base font-bold text-gray-900 whitespace-nowrap">Deposit Amount (MUSD)</th>
                    <th className="px-6 py-4 text-left text-base font-bold text-gray-900 whitespace-nowrap">Deposit Date</th>
                    <th className="px-6 py-4 text-left text-base font-bold text-gray-900 whitespace-nowrap">Withdrawn (MUSD)</th>
                    <th className="px-6 py-4 text-left text-base font-bold text-gray-900 whitespace-nowrap">Interest Earned (MUSD)</th>
